...
export async function url_filtering(){
    ...
    if (!raw_data) {
        console.error("No data received from Truthout getNews");
        return null;
    }
    
    // Pattern for Truthout article URLs - matches article URLs while excluding sections and other pages
    const pattern = /https:\/\/truthout\.org\/articles\/[a-z0-9-]+\/?$/g;
